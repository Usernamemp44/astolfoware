...
void CFonts::Initialize()
{
	...
	vgasyst = gInts.Surface->CreateFont();
}
void CFonts::Reload()
{
	...
	gInts.Surface->SetFontGlyphSet(gFonts.vgasyst, "vgasyst", 48, 1000, 0, 0, FONTFLAG_ANTIALIAS);
...
{	
	...
	static const std::uint8_t dark_gray_t[4] = { 50, 50, 50, 255 };
	gInts.Surface->DrawSetTextureRGBA(dark_gray, dark_gray_t, 1, 1);
	static const std::uint8_t team_blue_t[4] = { 0, 128, 255, 255 };
	gInts.Surface->DrawSetTextureRGBA(team_blue, team_blue_t, 1, 1);
	static const std::uint8_t team_red_t[4] = { 186, 52, 53, 255 };
...
//===================================================================================
std::uint8_t CDraw::GetESPHeight()
{
	return ESP_HEIGHT;
}
//===================================================================================
