...
#pragma optimize("gsy",on) // i dont even know what it "optimizes" here.
...
public:
	ClientClass* GetAllClasses(void)
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 8)(this); //Return the pointer to the head CClientClass.
	}
};
...
public:
	...
	Vector& GetAbsOrigin()
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 9)(this);
	}
	bool IsBaseCombatWeapon()
	{
		typedef bool(__thiscall *OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 137)(this);
	}
	int GetHitboxSet()
	{
	...
	bool IsAlive()
	{
		return *(std::uint8_t*)(this + gNetVars.get_offset("DT_BasePlayer", "m_lifeState")) == LIFE_ALIVE;
	}
	...
	{
		typedef Vector& (__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 10)(this);
	}
	...
	DWORD* GetModel()
	{
		...
		return Utils::CallVirtual<OriginalFn>(pRenderable, 9)(pRenderable);
	}
	...
	bool SetupBones(matrix3x4 *pBoneToWorldOut, int nMaxBones, int boneMask, float currentTime)
	{
		...
		return Utils::CallVirtual<OriginalFn>(pRenderable, 16)(pRenderable, pBoneToWorldOut, nMaxBones, boneMask, currentTime);
	}
	ClientClass* GetClientClass()
	{
		PVOID pNetworkable = (PVOID)(this + 0x8);
		typedef ClientClass* (__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(pNetworkable, 2)(pNetworkable);
	}
	bool IsDormant()
	{
		PVOID pNetworkable = (PVOID)(this + 0x8);
		typedef bool(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(pNetworkable, 8)(pNetworkable);
	}
	int GetIndex()
	{
		PVOID pNetworkable = (PVOID)(this + 0x8);
		typedef int(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(pNetworkable, 9)(pNetworkable);
	}
	void GetRenderBounds(Vector& mins, Vector& maxs)
	{
		PVOID pRenderable = (PVOID)(this + 0x4);
		typedef void(__thiscall* OriginalFn)(PVOID, Vector&, Vector&);
		Utils::CallVirtual<OriginalFn>(pRenderable, 20)(pRenderable, mins, maxs);
	}
	...
	matrix3x4& GetRgflCoordinateFrame()
	{
		...
		return Utils::CallVirtual<OriginalFn>(pRenderable, 34)(pRenderable);
	}

	int GetMaxHealth()
	{
		typedef int(__thiscall *OriginalFn)(void*);
		return Utils::CallVirtual<OriginalFn>(this, 107)(this);
	}
...
public:
	...
	{
		typedef int(__thiscall * OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 318)(this);
	}
	...
	{
		typedef int(__thiscall * OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 319)(this);
	}

	int GetSlot()
	{
		typedef int(__thiscall *OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 327)(this);
	}

	char *GetName()
	{
		typedef char *(__thiscall * OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 329)(this);
	}

	char *GetPrintName()
	{
		typedef char *(__thiscall * OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 330)(this);
	}
	float GetSpread()
	{
...
public:
	int GetPlayerForUserID(int UserID)
	{
		...
		return Utils::CallVirtual<Original>(this, 9)(this, UserID);
	}
	void ServerCmd(const char* chCommandString, bool bReliable = true)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, const char *, bool);
		return Utils::CallVirtual<OriginalFn>(this, 6)(this, chCommandString, bReliable);
	}
	void GetScreenSize(int& width, int& height)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, int&, int&);
		return Utils::CallVirtual<OriginalFn>(this, 5)(this, width, height);
	}
	bool GetPlayerInfo(int ent_num, player_info_t *pinfo)
	{
		typedef bool(__thiscall* OriginalFn)(PVOID, int, player_info_t *);
		return Utils::CallVirtual<OriginalFn>(this, 8)(this, ent_num, pinfo);
	}
	bool Con_IsVisible(void)
	{
		typedef bool(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 11)(this);
	}
	int GetLocalPlayer(void)
	{
		typedef int(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 12)(this);
	}
	float Time(void)
	{
		typedef float(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 14)(this);
	}
	void GetViewAngles(Vector& va)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, Vector& va);
		return Utils::CallVirtual<OriginalFn>(this, 19)(this, va);
	}
	void SetViewAngles(Vector& va)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, Vector& va);
		return Utils::CallVirtual<OriginalFn>(this, 20)(this, va);
	}
	int GetMaxClients(void)
	{
		typedef int(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 21)(this);
	}
	bool IsInGame(void)
	{
		typedef bool(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 26)(this);
	}
	bool IsConnected(void)
	{
		typedef bool(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 27)(this);
	}
	bool IsDrawingLoadingImage(void)
	{
		typedef bool(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 28)(this);
	}
	const matrix3x4& WorldToScreenMatrix(void)
	{
		typedef const matrix3x4& (__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 36)(this);
	}
	bool IsTakingScreenshot(void)
	{
		typedef bool(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 85)(this);
	}
	CNetChan* GetNetChannelInfo(void)
	{
		typedef CNetChan* (__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 72)(this);
	}
	void ClientCmd(const char* szCommandString)
	{
		typedef void(__thiscall* ClientCmdFn)(void*, const char*);
		return Utils::CallVirtual<ClientCmdFn>(this, 7)(this, szCommandString);
	}
	int GetAppId()
	{
		typedef int(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 104)(this);
	}
	void ClientCmd_Unrestricted(const char* chCommandString)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, const char *);
		return Utils::CallVirtual<OriginalFn>(this, 106)(this, chCommandString);
	}
	void ServerCmdKeyValues(PVOID kv)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, PVOID);
		Utils::CallVirtual<OriginalFn>(this, 127)(this, kv);
	}
...
public:
	const char *GetName(unsigned int vguiPanel)
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 36)(this, vguiPanel);
	}
	void SetMouseInputEnabled(unsigned int panel, bool state)
	{
		Utils::CallVirtual<void(__thiscall *)(void*, int, bool)>(this, 32)(this, panel, state);
	}
	void SetTopmostPopup(unsigned int panel, bool state)
	{
		Utils::CallVirtual<void(__thiscall *)(void*, int, bool)>(this, 59)(this, panel, state);
	}
};
...
public:
	void DrawSetColor(int r, int g, int b, int a)
	{
		...
		Utils::CallVirtual<OriginalFn>(this, 11)(this, r, g, b, a);
	}
	void DrawFilledRect(int x0, int y0, int x1, int y1)
	{
		typedef void(__thiscall* OriginalFn)(void*, int, int, int, int);
		Utils::CallVirtual<OriginalFn>(this, 12)(this, x0, y0, x1, y1);
	}
	void DrawOutlinedRect(int x0, int y0, int x1, int y1)
	{
		typedef void(__thiscall* OriginalFn)(void*, int, int, int, int);
		Utils::CallVirtual<OriginalFn>(this, 14)(this, x0, y0, x1, y1);
	}
	void DrawSetTextFont(unsigned long font)
	{
		typedef void(__thiscall* OriginalFn)(void*, unsigned long);
		Utils::CallVirtual<OriginalFn>(this, 17)(this, font);
	}
	void DrawSetTextColor(int r, int g, int b, int a)
	{
		typedef void(__thiscall* OriginalFn)(void*, int, int, int, int);
		Utils::CallVirtual<OriginalFn>(this, 19)(this, r, g, b, a);
	}
	void DrawSetTextPos(int x, int y)
	{
		typedef void(__thiscall* OriginalFn)(void*, int, int);
		Utils::CallVirtual<OriginalFn>(this, 20)(this, x, y);
	}
	void DrawPrintText(const wchar_t *text, int textLen)
	{
		typedef void(__thiscall* OriginalFn)(void*, const wchar_t *, int, int);
		return Utils::CallVirtual<OriginalFn>(this, 22)(this, text, textLen, 0);
	}
	unsigned long CreateFont()
	{
		typedef unsigned int(__thiscall* OriginalFn)(void*);
		return Utils::CallVirtual<OriginalFn>(this, 66)(this);
	}
	void SetFontGlyphSet(unsigned long &font, const char *windowsFontName, int tall, int weight, int blur, int scanlines, int flags)
	{
		typedef void(__thiscall* OriginalFn)(void*, unsigned long, const char*, int, int, int, int, int, int, int);
		Utils::CallVirtual<OriginalFn>(this, 67)(this, font, windowsFontName, tall, weight, blur, scanlines, flags, 0, 0);
	}
	void GetTextSize(unsigned long font, const wchar_t *text, int &wide, int &tall)
	{
		typedef void(__thiscall* OriginalFn)(void*, unsigned long, const wchar_t *, int&, int&);
		Utils::CallVirtual<OriginalFn>(this, 75)(this, font, text, wide, tall);
	}
	int CreateNewTextureID(bool procedural = true)
	{
		typedef int(__thiscall *OriginalFn)(void*, bool);
		return Utils::CallVirtual<OriginalFn>(this, 37)(this, procedural);
	}
	void DrawSetTextureRGBA(int id, unsigned char const* rgba, int wide, int tall, int hardwareFilter = 0, bool forceReload = 0)
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 31)(this, id, rgba, wide, tall, hardwareFilter, forceReload);
	}
	void DrawSetTexture(int id)
	{
		typedef void(__thiscall *OriginalFn)(void*, int);
		return Utils::CallVirtual<OriginalFn>(this, 32)(this, id);
	}
	bool IsTextureIDValid(int id)
	{
		typedef bool(__thiscall *OriginalFn)(void*, int);
		return Utils::CallVirtual<OriginalFn>(this, 35)(this, id);
	}
	void DrawTexturedRect(int x, int y, int width, int height)
	{
		typedef void(__thiscall *OriginalFn)(void*, int, int, int, int);
		return Utils::CallVirtual<OriginalFn>(this, 34)(this, x, y, width, height);
	}
	void DrawTexturedPolygon(int n, Vertex_t *vertices, bool bClipVertices = 1)
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 102)(this, n, vertices, bClipVertices);
	}
	void DrawLine(int x, int y, int x1, int y1)
	{
		typedef void(__thiscall *OriginalFn)(void*, int, int, int, int);
		return Utils::CallVirtual<OriginalFn>(this, 15)(this, x, y, x1, y1);
	}
	void GetCursorPosition(int &x, int &y)
	{
		return Utils::CallVirtual<void(__thiscall *)(void*, int &, int &)>(this, 96)(this, x, y);
	}
	void DrawSetAlphaMultiplier(float alpha)
	{
		typedef void(__thiscall* FN)(PVOID, float);
		return Utils::CallVirtual<FN>(this, 108)(this, alpha);
	}
};
...
public:
	CBaseEntity* GetClientEntity(int entnum)
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 3)(this, entnum);
	}
	CBaseEntity* GetClientEntityFromHandle(HANDLE hEnt)
	{
		typedef CBaseEntity* (__thiscall* OriginalFn)(PVOID, HANDLE);
		return Utils::CallVirtual<OriginalFn>(this, 4)(this, hEnt);
	}
	int GetHighestEntityIndex(void)
	{
		typedef int(__thiscall* OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 6)(this);
	}
};
...
public:	  //We really only need this I guess...
	void TraceRay(const Ray_t& ray, unsigned int fMask, ITraceFilter* pTraceFilter, trace_t* pTrace)//5
	{
		...
		return Utils::CallVirtual<TraceRayFn>(this, 4)(this, ray, fMask, pTraceFilter, pTrace);
	}
};
...
public:
	bool AddListener(IGameEventListener2 *listener, const char *name, bool bServerSide)
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 3)(this, listener, name, bServerSide);
	}
};
...
public:
	bool IsChatPanelOutOfFocus(void)
	{
		...
		PVOID CHudChat = Utils::CallVirtual<OriginalFn>(this, 19)(this);
		if (CHudChat)
		{
