...
public:
	void ForcedMaterialOverride(IMaterial *mat, OverrideType_t type = OverrideType_t::OVERRIDE_NORMAL)
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 1)(this, mat, type);
	}
	...
	void DrawModelExecute(const DrawModelState_t *state, const ModelRenderInfo_t &pInfo, matrix3x4 *pCustomBoneToWorld)
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 19)(this, state, pInfo, pCustomBoneToWorld);
	}
};
...
public:
	void SetBlend(float fl)
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 4)(this, fl);
	}
	void SetColorModulation(const float *col)
	{
		typedef void(__thiscall *OriginalFn)(PVOID, const float *);
		return Utils::CallVirtual<OriginalFn>(this, 6)(this, col);
	}
};
...
public:
	IMaterial* FindMaterial(char const* pMaterialName, const char *pTextureGroupName, bool complain = true, const char *pComplainPrefix = NULL)
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 73)(this, pMaterialName, pTextureGroupName, complain, pComplainPrefix);
	}
	...
	IMaterial* CreateMaterial(char const* pMaterialName, KeyValues* kv)
	{
		...
		return Utils::CallVirtual<OriginalFn>(this, 72)(this, pMaterialName, kv);
	}

	IMaterial* GetMaterial(MaterialHandle_t h)
	{
		typedef IMaterial *(__thiscall *OriginalFn)(PVOID, MaterialHandle_t);
		return Utils::CallVirtual<OriginalFn>(this, 78)(this, h);
	}

	MaterialHandle_t FirstMaterial()
	{
		typedef MaterialHandle_t(__thiscall *OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 75)(this);
	}

	MaterialHandle_t InvalidMaterial()
	{
		typedef MaterialHandle_t(__thiscall *OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 77)(this);
	}

	MaterialHandle_t NextMaterial(MaterialHandle_t h)
	{
		typedef MaterialHandle_t(__thiscall *OriginalFn)(PVOID, MaterialHandle_t);
		return Utils::CallVirtual<OriginalFn>(this, 76)(this, h);
	}
};
...
public:
	...
	{
		typedef IMaterial *(__thiscall *OriginalFn)(PVOID, const char *, const char *, bool, const char *);
		return Utils::CallVirtual<OriginalFn>(this, 71)(this, pMaterialName, pTextureGroupName, complain, pComplainPrefix);
	}

	IMaterial* CreateMaterial(char const* pMaterialName, KeyValues* kv)
	{
		typedef IMaterial *(__thiscall *OriginalFn)(PVOID, const char*, KeyValues*);
		return Utils::CallVirtual<OriginalFn>(this, 70)(this, pMaterialName, kv);
	}
	...
	{
		typedef MaterialHandle_t(__thiscall *OriginalFn)(PVOID);
		return Utils::CallVirtual<OriginalFn>(this, 73)(this);
	}
	...
	{
		typedef MaterialHandle_t(__thiscall *OriginalFn)(PVOID, MaterialHandle_t);
		return Utils::CallVirtual<OriginalFn>(this, 74)(this, h);
	}
};